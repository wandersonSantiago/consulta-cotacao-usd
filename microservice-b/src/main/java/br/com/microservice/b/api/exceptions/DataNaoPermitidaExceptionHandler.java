...
@Provider
public class DataNaoPermitidaExceptionHandler implements ExceptionMapper<DataNaoPermitidaException> {

	@Override
	public Response toResponse(DataNaoPermitidaException exception) {
